...
### Public methods
#### `read(): void`
Reads the raw data from the `data` buffer into the packet memnbers.
...
### Public methods
#### `readInt32(): number`
Reads a 32 bit integer from the `data` buffer and advances the `bufferIndex` 4 bytes.

#### `writeInt32(value: number): void`
Writes a 32 bit integer to the `data` buffer and advances the `bufferIndex` 4 bytes.

#### `readUInt32(): number`
Reads an unsigned 32 bit integer from the `data` buffer and advances the `bufferIndex` 4 bytes.

#### `writeUInt32(value: number): void`
Writes an unsigned 32 bit integer to the `data` buffer and advances the `bufferIndex` 4 bytes.

#### `readShort(): number`
Reads a 16 bit integer from the `data` buffer and advances the `bufferIndex` 2 bytes.

#### `writeShort(value: number): void`
Writes a 16 bit integer to the `data` buffer and advances the `bufferIndex` 2 bytes.

#### `readUnsignedShort(): number`
Reads an unsigned 16 bit integer from the `data` buffer and advances the `bufferIndex` 2 bytes.

#### `writeUnsignedShort(value: number): void`
Writes an unsigned 16 bit integer to the `data` buffer and advances the `bufferIndex` 2 bytes.

#### `readByte(): number`
Reads an 8 bit integer from the `data` buffer and advances the `bufferIndex` 1 byte.

#### `writeByte(value: number): void`
Writes an 8 bit integer to the `data` buffer and advances the `bufferIndex` 1 byte.

#### `readUnsignedByte(): number`
Reads an unsigned 8 bit integer from the `data` buffer and advances the `bufferIndex` 1 byte.

#### `writeUnsignedByte(value: number): void`
Writes an unsigned 8 bit integer to the `data` buffer and advances the `bufferIndex` 1 byte.

#### `readBoolean(): number`
Reads a boolean from the `data` buffer and advances the `bufferIndex` 1 byte.

#### `writeByte(value: number): void`
Writes a boolean to the `data` buffer and advances the `bufferIndex` 1 byte.

#### `readFloat(): number`
Reads a 32 bit floating-point value from the `data` buffer and advances the `bufferIndex` 4 bytes.

#### `writeFloat(value: number): void`
Writes a 32 bit floating-point value to the `data` buffer and advances the `bufferIndex` 4 bytes.
